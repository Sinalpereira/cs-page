                ...
                <div class="main-section">
                    ...
                    <div className="main-wrapper">
                        <div className="entries-section">
                            <div className="left common-padding">
                            ...
                            <div className="show-ct">
                                <ul>
                                    ...
                                    <li class="row">
                                        ...
                                        <div class="row-title w-20">
                                            <ul>
                                                <li className="staging color-green publish-status">Staging</li>
                                                <li className="production color-blue publish-status">Production</li>
                                            </ul>
                                        </div>
